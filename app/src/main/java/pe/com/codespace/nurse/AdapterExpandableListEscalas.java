 ...
 */
public class AdapterExpandableListEscalas extends BaseExpandableListAdapter {
    ...
    public AdapterExpandableListEscalas(Context context, List<String> listHeader, HashMap<String, List<String>> listChild){
